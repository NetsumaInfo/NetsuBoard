      ...
      {!compact && (
        <div className="flex flex-wrap items-center justify-between gap-2">
          <span className="flex flex-wrap items-center gap-2 text-xs font-medium text-muted-foreground">
            ...
            <span className="flex items-center gap-1"><ZoomIn className="h-3.5 w-3.5" /> {fmtNumber(scale, { minimumFractionDigits: 1, maximumFractionDigits: 1 })}×</span>
          </span>
          {variants.length > 1 && (
      ...
      >
        ...
        {compact && scale > 1 && (
          <div className="absolute bottom-2 right-2 z-20 flex items-center gap-1">
            <span className="rounded bg-black/60 px-1.5 py-0.5 text-[10px] font-medium tabular-nums text-white">{fmtNumber(scale, { minimumFractionDigits: 1, maximumFractionDigits: 1 })}×</span>
            <Tooltip>
              <TooltipTrigger
                render={
                  <Button
