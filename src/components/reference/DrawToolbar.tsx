...
// `combo` = la touche de l'outil, en badge dans l'infobulle. Le libellé accessible reste propre.
...
export function DrawToolbar() {
  ...
  const shortcutKeys = useBoard((s) => s.prefs.shortcutKeys); // raccourcis-commandes (annuler / rétablir)
