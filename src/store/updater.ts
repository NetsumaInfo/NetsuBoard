...
// lent ne doit pas fermer la fenêtre au milieu d'un upscale ou d'un export. Au-delà, la version
 ...
 * at launch. Autosave already protects the board, so the relaunch costs nothing but the seconds it
 * takes. A failed download simply stops here: the title-bar button holds the same update and the
 * usual two clicks still work.
 */
