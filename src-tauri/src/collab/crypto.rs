...
const HPKE_DOMAIN: &[u8] = b"NetsuBoard/project-key/v1\0";
const LABEL_CHECKPOINT: &[u8] = b"NetsuBoard/v1/checkpoint";
const LABEL_HEAD: &[u8] = b"NetsuBoard/v1/head";
const LABEL_THUMBNAIL: &[u8] = b"NetsuBoard/v1/thumbnail";
const LABEL_DIRECT_UPDATE: &[u8] = b"NetsuBoard/v1/direct-update";
