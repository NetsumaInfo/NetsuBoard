...
!macro NSIS_HOOK_PREINSTALL
  ; Une installation manuelle peut être lancée alors que NetsuBoard est encore ouvert. On demande
  ...
  Pop $0
  ${If} $0 != 0
    MessageBox MB_ICONSTOP|MB_OK "NetsuBoard n'a pas pu libérer son service de fond. Ferme NetsuBoard puis réessaie."
    Abort
  ${EndIf}
