...
/** @typedef {{ enabled:boolean, showBoard:boolean, showItems:boolean, showElapsed:boolean, detailsTpl:string, stateTpl:string }} DiscordPrefs */
...
function sanitizePrefs(raw) {
  ...
  for (const k of /** @type {const} */ (['enabled', 'showBoard', 'showItems', 'showElapsed'])) {
