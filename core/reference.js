...
function createReferenceStore(dataDir) {
  ...
  // Aperçu léger (JPEG 360p) d'un média local, écrit en ASSET de l'app : la collaboration l'envoie
  // aux pairs avant l'original, pour qu'une image de 40 Mo ou une vidéo montrent quelque chose en
  ...
  return {
    kind, listScenes, loadScene, saveScene, deleteScene, saveAsset, collabPreview, fetchAsset, resolveMedia,
