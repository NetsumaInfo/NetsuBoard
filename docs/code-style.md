...
- Factor repeated code (proxy/thumbnail/probe, gates) into one place. Shared helpers: `core/utils.js`, `src/lib/utils.ts` — the latter is the single renderer-side source, re-exported where convenient.
